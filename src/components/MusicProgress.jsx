      ...
      <div className="group/bar bar pt-3 mt-1" onClick={updateTime}>
        <div className="h-1 relative w-full bg-neutral-700 rounded-full ">
          <div
            ...
            className="h-full z-10 w-0 progress-bar bg-neutral-300 rounded-full group-hover/bar:bg-green-500 relative after:h-3 after:w-3 after:rounded-full after:top-1/2 after:-translate-y-1/2 after:right-0 after:scale-0
